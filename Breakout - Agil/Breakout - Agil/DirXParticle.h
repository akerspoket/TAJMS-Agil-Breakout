...
private:
	struct Emitter
	{
		...
		Emitter(vec3 pPosition, vec3 pColor, float pLifeTime, float pDensity, float pParticleLifeTime)
		{
			Position = pPosition;
			Color = pColor;
			LifeTime = pLifeTime;
...
public:
	...
	void AddNewEmitter(vec3 pPosition, vec3 pColor, float pLifeTime, float pDensity, float pParticleLifeTime);
